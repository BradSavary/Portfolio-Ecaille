...
export default function Projects() {
  return (
    <section className=" py-10 px-6 md:px-12 lg:px-20 bg-grid" >
      ...
      <div className="w-5/6 min-w-98 justify-self-center items-center flex flex-col md:flex-row gap-2 justify-center mt-15">
        <div className="border w-1/2 flex justify-center aspect-2/1"><TitleProject1 className="w-40"/></div>
        <div className="border w-1/2 flex justify-center aspect-2/1"><TitleProject2 className="w-40"/></div>
      </div>
